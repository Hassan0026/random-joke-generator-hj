...
export default function RandomJokeComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-green-300 to-green p-4">
      {/* Center the joke card within the screen */}
      <div className="bg-yellow-300 rounded-2xl shadow-lg p-8 w-full max-w-md">
        {/* Header with title */}
        <h1 className="text-3xl font-bold mb-4 text-red-600">
          😂 Random Joke 👈
        </h1>
        {/* Display the joke or a loading message */}
        <div className="bg-sky-200 rounded-lg p-6 mb-6 text-[#555] text-lg">
          {joke || "Loading..."}
        </div>
